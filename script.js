var phones = [
    ...
    },
    {
        ...
        price: "5 199 грн ",
        name:
            "Samsung Galaxy J5 (2016) J510H/DS Black + защитное стекло + чехол! "
    },
    {
    ...
    },
    {
        ...
        price: "6 199 грн ",
        name:
            "Samsung Galaxy   J7 (2016) J710F/DS Gold + защитное стекло + чехол! "
    },
    {
    ...
    },
    {
        ...
        price: "11 999 грн ",
        name:
            "Samsung Galaxy A5 2017 Duos SM-A520 Black +    карта памяти 128гб! "
    },
    {
    ...
    },
    {
        ...
        price: "2799 грн ",
        name:
            "Samsung Galaxy J1 2016 SM-J120H Black + защитное    стекло + чехол! "
    },
    {
    ...
    },
    {
        ...
        price: "2 222 грн ",
        name:
            "Lenovo Vibe C (A2020) Black + УМБ PowerPlant 5200 mAh в подарок! "
    },
    {
...
function GetPriceInt(smartphone) {
    let str;
    if (typeof smartphone.price == "string") {
        str = smartphone.price.replace(" ", "");
        return parseInt(str);
    } else {
        str = smartphone.price.newUan.replace(" ", "");
        return parseInt(str);
    }
}
...
function SetSmartphones(phones) {
    phones.forEach(function(phone, index, phones) {
        ...
        review.textContent = phone.ratingRevievs;
        ...
        if (typeof phone.price == "string") {
            newPrice.textContent = phone.price;
        } else {
            oldPrice.textContent = phone.price.oldUan;
            newPrice.textContent = phone.price.newUan;
